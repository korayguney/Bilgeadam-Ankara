...
public class StringBenchMark {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("------------ STRING ------------\n\tElapsed Time is " + elapsedTime/1000 + " usec (Using String to reverse)");
        ...
        elapsedTime = System.nanoTime() - beginTime;
        System.out.println("-------- STRINGBUFFER --------\n\tElapsed Time is " + elapsedTime/1000 + " usec (Using StringBuffer to reverse)");
        ...
        elapsedTime = System.nanoTime() - beginTime;
        System.out.println("-------- STRINGBUILDER -------\n\tElapsed Time is " + elapsedTime/1000 + " usec (Using StringBuilder to reverse)");
